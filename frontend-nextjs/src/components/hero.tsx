    ...
    <section className="relative min-h-[720px] overflow-hidden border-b border-ok-line px-4 pb-14 pt-28 sm:px-6 sm:pt-32 md:min-h-[880px] md:px-10 md:pb-20 md:pt-40">
      ...
      <div className="relative z-10 mx-auto max-w-[1280px]">
        <h1
          ...
          style={{
            fontSize: "clamp(42px, 13vw, 148px)",
            lineHeight: 0.95,
            ...
            >
              {i === 1 ? (
                <em
                  ...
                  style={{
                    color: "var(--ok-neon)",
                    fontSize: "clamp(48px, 15vw, 176px)",
                    lineHeight: 0.88,
                  }}
                >
                  {line}
        ...
        <div className="mt-10 flex max-w-[900px] flex-col gap-8 md:mt-14 md:flex-row md:flex-wrap md:items-end md:gap-20">
          <p className="max-w-[460px] text-base leading-snug text-ok-mute sm:text-lg">
            {t.hero_sub}
          </p>
          <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row">
            <BookCallModal triggerLabel={t.hero_cta} />
            <a href="#services" className="ok-btn ok-btn-ghost w-full sm:w-auto">
              {t.hero_cta_2}
            </a>
          </div>
        </div>

        <div className="mt-14 grid grid-cols-2 gap-6 border-t border-ok-line pt-8 sm:mt-20 sm:gap-8 md:mt-24 md:grid-cols-4 md:gap-10">
          {t.stats.map((s, i) => (
            <div key={i}>
              <div
                className="text-3xl font-medium text-ok-text sm:text-4xl md:text-5xl"
